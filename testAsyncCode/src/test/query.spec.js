...
describe("The Query package Tests", function() {
	...
	describe("Parse function tests", function() {
		...
		it("Should return an object of all query params when a query string is passed without ?", function() {
			const query = "by=junaid-najeeb&popular=true&category=nodejs";
			const actual = parse(query);
	...
	describe("Stringify function tests", function() {
		...
		it("Should return an empty string when object is null and undefined", function() {
			const query = {
				popular: undefined,
				game: null
			};
